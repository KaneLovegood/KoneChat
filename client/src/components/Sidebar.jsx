...
import KoneChatLogo from "../assets/chat-app-assets/KoneChatLogo.png";
        ...
        {filteredUsers.map((user, index) => (
          <div
            ...
            onClick={() => {
              ...
              setUnseenMess((prev) => ({ ...prev, [user._id]: 0 }));
            }}
          ...
          >
            <img
              src={user?.img || assets.avatar_icon}
            ...
            {unseenMess && unseenMess[user._id] > 0 && (
